<div class="pages form">
	...
	<div class="row">
		<div class="col-md-12">
		<?
			echo $this->Form->create('Page', array('role' => 'form')); 
            ...
            <div class="form-group">
                ...
                <?
                    $titleCount = mb_strlen($this->request->data['Page']['meta_title']);
                    echo $this->Form->input('meta_title', array(
                        'class' => 'form-control',
                        'div' => 'input-group',
                        'after' => "<span id=\"titleCount\" class=\"input-group-addon\">$titleCount</span>",
                        'label' => false
                    ))
                ?>
            </div>
            <div class="form-group">
                ...
                <?
                $descriptionCount = mb_strlen($this->request->data['Page']['meta_description']);
                echo $this->Form->input('meta_description', array(
                    'class' => 'form-control',
                    'div' => 'input-group',
                    'after' => "<span id=\"descriptionCount\" class=\"input-group-addon\">$descriptionCount</span>",
                    'label' => false,
                    'rows' => 2
                ))
                ?>
            ...
            <div class="form-group">                
                    <?= $this->Form->input('text_descr', array(
                        'class' => 'form-control',
                        'div' => 'form-group'
                    )) ?>
            </div>
            <? if ( Configure::read('html_view') ): ?>
                ...
                <div class="form-group">
                    <label>Text</label>
                    <div id="editor"><?= htmlspecialchars($this->request->data['Page']['text']) ?></div>
                </div>
            <? else: ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <?= $this->Form->input('Relative', array(
                        'class' => 'form-control',
                        'div' => 'form-group',
                        'style' => 'height: 371px'
                    )); ?>
