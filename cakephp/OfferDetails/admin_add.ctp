	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="page-header">
				<h1><?= __('Admin Add Offer Detail') ?></h1>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<?= $this->Form->input('leads_offer_id', array(
						...
						'value' => ((!empty($this->request->query['leads_offer_id'])) ? $this->request->query['leads_offer_id'] : ''),
						'readonly' => ((!empty($this->request->query['leads_offer_id'])) ? true : false)
					)) ?>
					<?= $this->Form->input('domain_id', array(
						'class' => 'form-control',
						'div' => 'form-group',
						'value' => $this->request->query['domain_id'],
						'readonly' => true
						)) ?>
